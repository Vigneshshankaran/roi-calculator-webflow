...
export declare class Components {
     ...
     *     })
     */
    updateContent(siteId: string, componentId: string, request: Webflow.ComponentDomWrite, requestOptions?: Components.RequestOptions): core.HttpResponsePromise<Webflow.ComponentsUpdateContentResponse>;
