...
class Forms {
        ...
        return __awaiter(this, arguments, void 0, function* (siteId, request = {}, requestOptions) {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : ((_c = (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.WebflowEnvironment.DataApi)
                    .base, `sites/${core.url.encodePathParam(siteId)}/form_submissions`),
                method: "GET",
                headers: _headers,
    ...
    __listSubmissions(siteId_1, formId_1) {
        return __awaiter(this, arguments, void 0, function* (siteId, formId, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : ((_c = (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.WebflowEnvironment.DataApi)
                    .base, `sites/${core.url.encodePathParam(siteId)}/forms/${core.url.encodePathParam(formId)}/submissions`),
                method: "GET",
                headers: _headers,
                queryParameters: Object.assign(Object.assign({}, _queryParams), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams),
                timeoutMs: ((_f = (_d = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _d !== void 0 ? _d : (_e = this._options) === null || _e === void 0 ? void 0 : _e.timeoutInSeconds) !== null && _f !== void 0 ? _f : 60) * 1000,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.WebflowTimeoutError("Timeout exceeded when calling GET /sites/{site_id}/forms/{form_id}/submissions.");
                case "unknown":
                    throw new errors.WebflowError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
     ...
     */
    getSubmission(siteId, formSubmissionId, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__getSubmission(siteId, formSubmissionId, requestOptions));
    }
    __getSubmission(siteId, formSubmissionId, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : ((_c = (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.WebflowEnvironment.DataApi)
                    .base, `sites/${core.url.encodePathParam(siteId)}/form_submissions/${core.url.encodePathParam(formSubmissionId)}`),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.WebflowTimeoutError("Timeout exceeded when calling GET /sites/{site_id}/form_submissions/{form_submission_id}.");
                case "unknown":
                    throw new errors.WebflowError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
     ...
     */
    deleteSubmission(siteId, formSubmissionId, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__deleteSubmission(siteId, formSubmissionId, requestOptions));
    }
    __deleteSubmission(siteId, formSubmissionId, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.WebflowTimeoutError("Timeout exceeded when calling DELETE /sites/{site_id}/form_submissions/{form_submission_id}.");
                case "unknown":
                    throw new errors.WebflowError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
     ...
     */
    updateSubmission(siteId, formSubmissionId, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__updateSubmission(siteId, formSubmissionId, request, requestOptions));
    }
    __updateSubmission(siteId_1, formSubmissionId_1) {
        return __awaiter(this, arguments, void 0, function* (siteId, formSubmissionId, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({ Authorization: yield this._getAuthorizationHeader() }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : ((_c = (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.WebflowEnvironment.DataApi)
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.WebflowTimeoutError("Timeout exceeded when calling PATCH /sites/{site_id}/form_submissions/{form_submission_id}.");
                case "unknown":
                    throw new errors.WebflowError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
