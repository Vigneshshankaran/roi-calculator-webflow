...
export declare const Node: core.serialization.Schema<serializers.Node.Raw, Webflow.Node>;
export declare namespace Node {
    type Raw = Node.Text | Node.Image | Node.ComponentInstance | Node.TextInput | Node.Select | Node.SubmitButton | Node.SearchButton;
